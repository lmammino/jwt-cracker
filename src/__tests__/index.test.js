...
const tokenHS256 =
	'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6Imp3dC1jcmFjbGVyIiwiaWF0IjoxNTE2MjM5MDIyfQ.29OQn8UytvagAsG-OwnkzxO2lBw8QEWOuc8ltSZRWCU'
const tokenHS512 =
...
describe('Jwt-cracker', () => {
	test('should return secret found with HS256', (done) => {
		const app = spawn('node', ['src/index.js', '-t', tokenHS256])
	...
	test('should return secret found with HS512', (done) => {
		const app = spawn('node', ['src/index.js', '-t', tokenHS512])
